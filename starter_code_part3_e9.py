...
def main():
    ...
    CONFIG = {
        ...
        "learning_rate": 0.0008, # Use a small learning rate for finetuning since it is a pre-trained model
        "epochs": 70,  # Train for longer in a real scenario - using 20 epochs since resnet18 is a larger model that will take time to converge
