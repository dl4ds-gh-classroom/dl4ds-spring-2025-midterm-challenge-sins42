...
def load_pretrained_resnet18(CONFIG):
    ...
    # Freeze all layers except the last one (fully connected layer)
...
def main():
    ...
    CONFIG = {
        ...
        "epochs": 40,  # Train for longer in a real scenario - using 20 epochs since resnet18 is a larger model that will take time to converge
