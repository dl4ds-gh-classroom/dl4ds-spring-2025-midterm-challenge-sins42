...
def main():
    ...
    CONFIG = {
        ...
        "learning_rate": 0.0003, # Use a small learning rate for finetuning since it is a pre-trained model
    ...
    optimizer = optim.AdamW(model.parameters(), lr=CONFIG["learning_rate"], weight_decay=1e-3) #Use Adam optimizer
